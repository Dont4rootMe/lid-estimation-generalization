...
Третий attempt, task 9113, поднял все 24 canary worker, но также не прошёл
canary и не запустил full DAG. После 12 final и 12 incomplete cell directories
reference grid дал вычисленную через VP roundtrip верхнюю точку
`64.00000000000001`; строгий affine-FM checkpoint отклонил её как выход за
объявленный support `[1/256, 64]`. Та же floating-point погрешность возникала у
адаптивного расширения supervised grid на обеих границах. Исправление
канонизирует только созданные runner'ом значения, отклонившиеся не более чем на
четыре соседних представимых числа, к точным endpoints до prediction и
сохранения provenance. Более дальний выход, неканонический сохранённый grid,
