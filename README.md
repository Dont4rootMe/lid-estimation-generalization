...
данных: двенадцать field-интерфейсов, включая t-Flow и PFGM++, используют
U-Net width8 на изображениях и spectral residual width512 на коэффициентах.
NF сохраняет обратимую архитектуру: векторная ёмкость согласована с полями,
а image NF отдельно закреплён на восьми U-Net conditioners width9.
Общие правила обучения и выбора
